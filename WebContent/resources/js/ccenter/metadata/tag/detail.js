define(['Common','bs/modal','jq/form/wizard','bs/tooltip','jq/form/validator-bs3'],function(Common,Modal){
    ...
    var init = function(){
        ...
        Common.xhr.ajax("/resource-manager/v2/tag/"+tagId,function(tagInfo){
            curTagInfo = tagInfo;
            Common.render(true,'tpls/ccenter/metadata/tag/detail.html',tagInfo,function(html){
                bindEvent();
            });
        })
    };
    function bindEvent(){
        ...
        function renderTab(data){
            ...
            if('resources' == data){
                //获取磁盘快照列表
                Common.render(false,'tpls/ccenter/zone/list_resources.html',curTagInfo,function(html){

define(function(){
	var init = function(){
		...
		//需要修改为真实数据源
		require(['template','rq/text!'+PubVars.contextPath+'/resources/data/arrays.txt','rq/text!'+PubVars.contextPath+'/resources/tpls/cservice/db.html'],function(template,data,tpl){
			try{
				if(data){

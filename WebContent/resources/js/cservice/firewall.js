define(function(){
	var init = function(){
		...
		//需要修改为真实数据源
		require(['template','text!'+PubVars.contextPath+'/resources/data/arrays.txt','text!'+PubVars.contextPath+'/resources/tpls/cservice/firewall.tpl'],function(template,data,tpl){
			try{
				if(data){

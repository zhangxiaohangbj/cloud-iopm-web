define(['Common','bs/modal','jq/form/wizard','bs/tooltip','jq/form/validator-bs3','bs/switcher'],function(Common,Dialog){
	...
	var init = function(){
		...
		//先获取数据，进行加工后再去render
		Common.render(true,'tpls/bservice/emr/template/list.html',function(){
			bindEvent();
		});
	};
	...
	var bindEvent = function(){
		Common.initDataTable($('#networkTable'),{
		      ...
		      "sAjaxSource":"resources/data/bservice/emr/template.txt?", //ajax源，后端提供的分页接口
		      ...
		      "columns": [
			        ...
			        {"data": "vdc_name"},
			        {
			        	"defaultContent":'<a class="btn-edit" data-toggle="tooltip" title="编辑模板" href="javascript:void(0)" data-act="stop">编辑模板</a>'
			        		+'<a class="btn-delete" data-toggle="tooltip" title="编辑节点组" href="javascript:void(0)" style="margin: 0 8px;">编辑节点组</i></a>'
